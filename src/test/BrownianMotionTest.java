...
public class BrownianMotionTest {
    ...
    public void test() throws Exception {
        ...
        Assert.assertTrue(image.plot("Brownian Motion"));

    }

    private Problem runSimulation() throws Exception {
        BivariateFunction f = FunctionUtils.affine(0d, 0d, 0d); //mu = 2
        BivariateFunction g = FunctionUtils.affine(0d, 0d, .2d); //sigma = .5
        ...
        problem.setEquationText("Brownian Motion","dy=dW");
